...
mod tests {
	...
	use crate::tidal::session::SessionOptions;
	...
	#[test]
	fn test_parse_iso_duration_variations() {
		assert_eq!(TidalApi::parse_iso_duration("PT3M45S"), (3, 45));
		assert_eq!(TidalApi::parse_iso_duration("PT1H20M30S"), (80, 30));
		assert_eq!(TidalApi::parse_iso_duration("PT45S"), (0, 45));
		assert_eq!(TidalApi::parse_iso_duration("PT10M"), (10, 0));
		assert_eq!(TidalApi::parse_iso_duration("invalid_string"), (0, 0));
	}
}
